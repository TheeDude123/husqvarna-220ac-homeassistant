...
`notify.jonas` och `notify.alla` används för push-notiser. Byt ut `mobile_app_DIN_TELEFON` mot dina egna mobile_app-entitet (Settings → Devices & Services → Mobile App).
